...
function highChartFunc(cityid) {
    ...
    Highcharts.getJSON('database.php?station=' + cityid, function(data) {
        ...
        fogFunction(cityid, fogdata, fogdata2, temperaturedata, humiditydata, winddata, winddirectiondata)
...
function fogFunction(cityid, fogdata, fogdata2, temperaturedata, humiditydata, winddata, winddirectiondata) {
    var charts = []
    console.log(fogdata)
    charts.push(
                            ...
                            events: {
                                mouseOver: function(e) {
                                    ...
                                    if (charts[0].hoverSeries._i == 0) {
                                        ...
                                        document.getElementById("data-detail").innerHTML = "<h3><b>Visibility</b>:" + store[0].toFixed(2) + " km   <b>Temperature</b>:" + store[1].toFixed(2) + "°F    <b>Relative Humidity</b>:" + store[2].toFixed(2) + " %    <b>Wind</b> :" + store[3].toFixed(2) + "Km/h " + store[4] + "°N" + " </h3>   ";
                                    } else if (charts[0].hoverSeries._i == 1) {
                                        document.getElementById("data-detail").innerHTML = "<h3><b>Predicted Visibility</b>:" + charts[0].series[1].points[this.index - k].y.toFixed(2) + " km";
